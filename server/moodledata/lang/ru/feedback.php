...
/**
 * Strings for component 'feedback', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   feedback
...
$string['do_not_analyse_empty_submits'] = 'Не анализировать пустые предложения';
...
$string['email_notification_help'] = 'При включенном параметре администраторы получают уведомление электронной почты о представлении ответов Обратной связи.';
...
$string['feedback:mapcourse'] = 'Отображать курсы с глобальной обратной связью';
...
$string['mapcoursenone'] = 'Нет подключенных курсов. Обратная связь доступна для всех курсов';
