...
/**
 * Strings for component 'form', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   form
...
$string['hideeditortoolbar'] = 'Скрыть инструменты редактирования';
$string['hour'] = 'Час';
...
$string['showeditortoolbar'] = 'Показать инструменты редактирования';
