...
/**
 * Strings for component 'plugin', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   plugin
...
$string['err_response_format_version'] = 'Непредвиденная версия формата отклика. Попробуйте еще раз проверить наличие обновлений.';
$string['err_response_http_code'] = 'Невозможно получить имеющиеся обновления данных - непредвиденный HTTP- код отклика.';
...
Вам нужно сделать папку с плагином и все её содержимое доступным для записи, чтобы иметь возможность автоматически установить имеющиеся обновления.';
...
$string['status_delete'] = 'Будет удалено';
