...
/**
 * Strings for component 'condition', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   condition
...
$string['requires_user_field_endswith'] = 'Недоступно, если Ваше поле <strong>{$a->field}</strong> не заканчивается <strong>{$a->value}.</strong>';
$string['requires_user_field_isempty'] = 'Недоступно, если Ваше поле <strong>{$a->field}</strong> не пустое.';
$string['requires_user_field_isequalto'] = 'Недоступно, если Ваше поле <strong>{$a->field}</strong> не равно <strong>{$a->value}.</strong>';
$string['requires_user_field_isnotempty'] = 'Недоступно, если Ваше поле <strong>{$a->field}</strong> пустое.';
$string['requires_user_field_startswith'] = 'Недоступно, если Ваше поле <strong>{$a->field}</strong> не начинается <strong>{$a->value}</strong>.';
