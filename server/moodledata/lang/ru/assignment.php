...
/**
 * Strings for component 'assignment', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   assignment
...
$string['addsubmission'] = 'Добавить задание';
...
$string['changegradewarning'] = 'Это задание с оцененными представлениями и изменение оценки не будет автоматически пересчитать существующие оценки представлений. Необходимо повторно переоценить все существующие представления, если Вы хотите изменить оценку.';
...
<p>Например, где-либо в сети или лицом к лицу. Студенты видят описание задания, но не могут в ответ загрузить файлы и др..</p>
<p>Оценивание заданий работает обычно и студенты будут получать уведомления о своих оценках.</p>';
...
<p> Завершение заданий такого рода может быть вручную указано студентом. Вы можете в любое время просмотреть текущее состояние и отметить незавершённые задания как черновик. Любое неоцененное задание Вы можете вернуть к статусу черновика. </p>';
