...
/**
 * Strings for component 'data', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   data
...
$string['modulename_help'] = 'Модуль "База данных" позволяет участникам создавать, обслуживать и искать записи из совокупности. Структура записей определяется преподавателем через количество полей. Типы полей включают флажки, переключатели, выпадающие меню, текстовые области, гиперссылки, изображения и загружаемые файлы.
