...
/**
 * Strings for component 'tool_xmldb', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   tool_xmldb
...
$string['confirmcheckbigints'] = 'Это возможность найти <a href="http://tracker.moodle.org/browse/MDL-11038">потенциально неверные целочисленные поля</a> на сервере Moodle, автоматически создавая (но не исполняя!) необходимые утверждения SQL, чтобы все целые числа в БД были правильно определены.<br /><br /> Когда утверждения созданы, Вы можете их скопировать и запустить безопасно с помощью интерфейса SQL (не забудьте сделать резервную копию своих данных, прежде чем делать это).<br /><br /> Крайне рекомендуется, чтобы у Вас был самый свежий (версия +) доступный релиз Moodle (1.8, 1.9, 2.x ...) перед выполнением поиска неверных целочисленных полей.<br /><br />Этот функционал не выполняет никаких действий с БД (только читает из нее), поэтому Вы можете запускать его безопасно в любой момент.';
$string['confirmcheckdefaults'] = 'Это возможность найти противоречивые значения по умолчанию на Вашем сервере Moodle, создавая (но не исполняя!) необходимые утверждения SQL, чтобы все значения по умолчанию были правильно заданы.<br /><br /> Когда утверждения созданы, Вы можете их скопировать и запустить безопасно с помощью интерфейса SQL (не забудьте перед этим сделать резервную копию своих данных).<br /><br /> Крайне рекомендуется, чтобы у Вас был самый свежий (версия +) доступный релиз Moodle (1.8, 1.9, 2.x ...) перед выполнением поиска неверных значений по умолчанию.<br /><br /> Этот функционал не выполняет никаких действий с БД (только читает из нее), поэтому Вы можете запускать его безопасно в любой момент.';
$string['confirmcheckforeignkeys'] = 'Это возможность найти потенциально неверные внешние ключи, определенные в install.xml. (Moodle в настоящее время не создает действующие ограничения для внешних ключей в базе данных, поэтому в ней могут присутствовать недопустимые данные.)<br /><br /> Крайне рекомендуется, чтобы у Вас был самый свежий (версия +) доступный релиз Moodle (1.8, 1.9, 2.x ...) перед выполнением поиска отсутствующих индексов.<br /><br />Этот функционал не выполняет никаких действий с БД (только читает из нее), поэтому Вы можете запускать его безопасно в любой момент.';
$string['confirmcheckindexes'] = 'Это возможность найти потенциально пропущенные индексы на Вашем сервере Moodle, автоматически создавая (но не исполняя!) необходимые утверждения SQL, чтобы все было обновлено.<br /><br /> Когда утверждения созданы, Вы можете их скопировать и запустить безопасно с помощью интерфейса SQL (не забудьте перед этим сделать резервную копию своих данных).<br /><br /> Крайне рекомендуется, чтобы у Вас был самый свежий (версия +) доступный релиз Moodle (1.8, 1.9, 2.x ...) перед выполнением поиска пропущенных индексов.<br /><br /> Этот функционал не выполняет никаких действий с БД (только читает из нее), поэтому Вы можете запускать его безопасно в любой момент.';
$string['confirmcheckoraclesemantics'] = 'Это возможность поиска <a href="http://tracker.moodle.org/browse/MDL-29322">Oracle varchar2 columns using BYTE semantics</a> на сервере Moodle, автоматически создавая (но не исполняя!) необходимые утверждения SQL, чтобы все  столбцы были преобразованы к использованию CHAR-семантики вместо BYTE-семантики (лучше для  совместимости перекрестной БД и увеличенной макс. длины содержимого).<br /><br /> Когда утверждения созданы, Вы можете их скопировать и запустить безопасно с помощью интерфейса SQL (не забудьте перед этим сделать резервную копию своих данных).<br /><br /> Крайне рекомендуется, чтобы у Вас был самый свежий (версия +) доступный релиз Moodle (1.8, 1.9, 2.x ...) перед выполнением поиска BYTE-семантики.<br /><br />Этот функционал не выполняет никаких действий с БД (только читает из нее), поэтому Вы можете запускать его безопасно в любой момент.';
