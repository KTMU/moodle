...
/**
 * Strings for component 'grading', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   grading
...
$string['activemethodinfonone'] = 'Для области "{$a->area}" выбран не передовой метод оценивания. Будет использоваться простое прямое оценивание.';
...
$string['gradingformunavailable'] = 'Пожалуйста, обратите внимание: форма передового  оценивания не готова в данный момент. Пока форма не имеет допустимого статуса будет использоваться простой метод оценивания.';
...
$string['gradingmethod_help'] = 'Выберите дополнительный метод оценивания, который будет использован для подсчета оценок в заданном контексте.

Для отключения дополнительного метода оценивания и возврата к стандартному механизму, выберите \'Простое оценивание\'.';
$string['gradingmethodnone'] = 'Простое оценивание';
...
* Вы можете без удаления этой формы переключиться на другой метод оценивания, в т.ч. на "Простое прямое оценивание".
...
$string['searchtemplate_help'] = 'Здесь Вы можете найти форму оценивания и использовать её в качестве шаблона для новой формы оценивания. Просто введите слова, которые должны присутствовать где-нибудь в названии формы, её описании или содержимом формы. Чтобы найти фразу, заключите весь запрос в двойные кавычки.
