...
/**
 * Strings for component 'lesson', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   lesson
...
$string['addbranchtable'] = 'Добавить страницу с контентом';
$string['addcluster'] = 'Добавить кластер';
$string['addedabranchtable'] = 'Добавлена страница с контентом';
...
$string['mediafile'] = 'Файл в всплывающем окне';
...
$string['topscorestitle'] = 'Самые высокие баллы - {$a}';
