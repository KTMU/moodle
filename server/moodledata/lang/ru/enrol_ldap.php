...
/**
 * Strings for component 'enrol_ldap', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   enrol_ldap
...
$string['idnumber_attribute'] = 'Если членство в группе  содержит различающиеся имена, то использовать тот же атрибут "ID-номер", который указан в параметрах LDAP-аутентификации';
...
$string['user_attribute'] = 'Если членство в группе содержит различающиеся имена, то укажите атрибут, использующийся для имени/поиска пользователей. При использовании LDAP-аутентификации это значение должно совпадать с значением, заданным атрибутом "ID Number" в плагине LDAP-аутентификации.';
