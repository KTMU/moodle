...
/**
 * Strings for component 'report_performance', language 'ru', branch 'MOODLE_25_STABLE'
 *
...
$string['check_backup_comment_enable'] = 'Производительность может снижаться время проведения резервного копирования. Резервное копирование должно планироваться на время низкой нагрузки.';
...
$string['check_enablestats_details'] = 'При включении будут обрабатываться логи в Cronjob и собираться статистика. В зависимости от трафика на сайте, это может занять некоторое время. <p> Этот процесс будет потреблять больше ресурсов сервера и может снизить производительность. </p>';
...
$string['check_themedesignermode_details'] = 'Это часто является причиной медленной работы сайтов Moodle. <p> Включение режима дизайнера темы может в среднем в два раза нагрузить процессор. </p>';
...
$string['pluginname'] = 'Обзор производительности';
