...
/**
 * Strings for component 'editor_tinymce', language 'ru', branch 'MOODLE_25_STABLE'
 *
...
$string['customconfig_desc'] = 'Пользовательские расширенные настройки TinyMCE в JSON формате, например: {"option1" : "value2", "option2" : "value2"}. Любые указанные здесь параметры заменяют стандартные и настройки плагина.';
