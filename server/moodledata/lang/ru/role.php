...
/**
 * Strings for component 'role', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   role
...
$string['customroledescription_help'] = 'Стандартные описания ролей применяются автоматически, если пользовательские описания пусты.';
$string['customrolename'] = 'Пользовательское полное название';
$string['customrolename_help'] = 'Стандартные названия ролей применяются автоматически, если пользовательские названия пусты. Вы должны указать пользовательские полные названия для всех ролей.';
...
$string['roleshortname_help'] = 'Короткое название роли является её идентификатором, в котором допускаются только буквенно-цифровые символы ASCII. Не изменяйте короткие названия стандартных ролей.';
