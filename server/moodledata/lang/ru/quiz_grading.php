...
/**
 * Strings for component 'quiz_grading', language 'ru', branch 'MOODLE_25_STABLE'
 *
...
$string['bystudentname'] = 'По имени студента';
...
$string['grading:componentname'] = 'Классификация {$a->number} вопрос: {$a->questionname}Отчет оценивания вручную';
...
$string['questionsthatneedgrading'] = 'Вопросы, которые должны оценены';
