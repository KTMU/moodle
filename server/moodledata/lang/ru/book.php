...
/**
 * Strings for component 'book', language 'ru', branch 'MOODLE_25_STABLE'
 *
 * @package   book
...
$string['page-mod-book-x'] = 'Любая страница модуля Книга';
$string['pluginadministration'] = 'Управление книгой';
$string['pluginname'] = 'Книга';
$string['subchapter'] = 'Подраздел';
$string['subchapternotice'] = '(Только одна первая глава была создана)';
